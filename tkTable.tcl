# table.tcl --
#
# version 1.2, jhobbs@cs.uoregon.edu
...
# FIX - improve to delete whole rows/cols
proc tk_tableCut w {
  if {[selection own -displayof $w] == "$w"} {
    clipboard clear -displayof $w
    catch {
...
proc tk_tablePaste {w {cell {}}} {
  if [string comp {} $cell] {
    ...
    if [catch {selection get -displayof $w -selection CLIPBOARD} data] return
    set cell active
  }
...
# FIX - improve to not overwrite contents, but rather insert them
